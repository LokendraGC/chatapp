          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="leading-relaxed">
                By accessing or using the Karmi AI Chatbot Bot, you agree to be
            ...
            <section>
              ...
              <p className="leading-relaxed">
                Permission is granted to temporarily use the Karmi AI Chatbot
                Bot for personal, non-commercial transitory viewing only. This
            ...
            <section>
              ...
              <p className="leading-relaxed">
                The materials within the Karmi AI Chatbot are provided on an 'as
                is' basis. Karmi AI Chatbot makes no warranties, expressed or
            ...
            <section>
              ...
              <p className="leading-relaxed">
                In no event shall Karmi AI Chatbot or its suppliers be liable
                ...
                of the use or inability to use the Karmi AI Chatbot Bot, even if
                Karmi AI Chatbot or an authorized representative has been
            ...
            <section>
              ...
              <p className="leading-relaxed">
                Karmi AI Chatbot may revise these terms of service for its bot
