        ...
        <div className="flex items-center gap-2 sm:gap-3 md:gap-8 text-sm font-light text-zinc-300 shrink-0">
          <SignedIn>
            <div className="flex items-center gap-2 sm:gap-4">
              <Link
                href="/dashboard"
                className="h-9 sm:h-11 cursor-pointer px-4 sm:px-8 rounded-full border border-zinc-800 text-zinc-300 text-xs sm:text-sm font-medium hover:text-white transition-all flex items-center gap-2 bg-black/30"
              >
                <span>Dashboard</span>
              </Link>
            </div>
